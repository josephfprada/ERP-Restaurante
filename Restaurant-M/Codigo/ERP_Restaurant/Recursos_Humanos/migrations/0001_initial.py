    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefonoEmpleado', models.CharField(max_length=17)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idEmpleado', models.ForeignKey(db_column='idEmpleado', on_delete=django.db.models.deletion.DO_NOTHING, to='Recursos_Humanos.empleado')),
            ],
            options={
                'db_table': 'Documentos',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_inicio', models.DateField()),
                ('fecha_fin', models.DateField()),
                ('idEmpleado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Recursos_Humanos.empleado')),
            ],
            options={
                'db_table': 'Beneficios',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idDepartamento', models.ForeignKey(db_column='idDepartamento', on_delete=django.db.models.deletion.DO_NOTHING, to='Recursos_Humanos.departamento')),
                ('idEmpleado', models.ForeignKey(db_column='idEmpleado', on_delete=django.db.models.deletion.DO_NOTHING, to='Recursos_Humanos.empleado')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idEmpleado', models.ForeignKey(blank=True, db_column='idEmpleado', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Recursos_Humanos.empleado')),
            ],
            options={
                'db_table': 'Pago',
                'managed': True,
